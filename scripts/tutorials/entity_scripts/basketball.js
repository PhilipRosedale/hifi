//  basketball.js
//
//  When trigger is pressed, attract ball to your hand with force proportional 
//  to inverse of distance.  
//
...
(function(){ 
    ...
    function springForce(position, center, radius) {
        ...
        return Vec3.multiply(1.0 - distance / radius, Vec3.normalize(Vec3.subtract(position, center)));
    }
    ...
    this.maybePush = function() {
        ...
        if (leftTrigger > 0.1) {
            addVelocity = Vec3.sum(addVelocity, Vec3.multiply(springForce(leftFingerPosition, props.position, TOO_FAR), strength));
        }
        if (rightTrigger > 0.1) {
            addVelocity = Vec3.sum(addVelocity, Vec3.multiply(springForce(rightFingerPosition, props.position, TOO_FAR), strength));
        }
